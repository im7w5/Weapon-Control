...
-- Ignore damage between the same player (self-harm protection)
Config.IgnoreSelfDamage = true

-- Allow NPC -> player damage to use these values too
Config.ApplyToNPCAttackers = true

-- Default values used for any weapon not explicitly listed below
Config.Default = {
    body               = 20,
    headshotMultiplier = 2.0,
    falloffStart       = 15.0,
    falloffPerMeter    = 0.01,   -- -1% per meter past falloffStart
    maxFalloff         = 0.80,
}

-- ============================================================
--  Per-weapon table. Keys are weapon hashes via GetHashKey.
--  Tune each value to balance your server.
-- ============================================================
Config.Weapons = {
    ----------------------------------------------------------------
    -- UNARMED / MELEE  (no range falloff)
    ----------------------------------------------------------------
    ...
    ----------------------------------------------------------------
    -- SHOTGUNS (short range, heavy falloff)
    ----------------------------------------------------------------
    ...
    ----------------------------------------------------------------
    -- SNIPER RIFLES (long range, minimal falloff)
    ----------------------------------------------------------------
...
-- ============================================================
-- Head bone IDs used to detect headshot reliably
-- ============================================================
Config.HeadBones = {
